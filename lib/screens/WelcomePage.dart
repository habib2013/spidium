  ...
  void initState() {
    ...
    _scale2Animation = Tween<double>(
      ...
      if (status == AnimationStatus.completed) {
        ...
        Navigator.pushAndRemoveUntil(context, PageTransition(type: PageTransitionType.fade,child: LoginPage()), (route) => false);
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child:  Column(
                ...
                children: <Widget>[
                  FadeAnimation(1, Text("Spidium",
                    style: TextStyle(color: Colors.white, fontSize: 50,fontFamily: 'Josefin Sans',),)),
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("Join a world full of creative writers \n and storytellers plus top trending \n news at your fingertip",
                    style: TextStyle(color: Colors.white.withOpacity(.7), height: 1.4, fontSize: 20,fontFamily: 'Josefin Sans'),)),
                  SizedBox(height: 180,),
